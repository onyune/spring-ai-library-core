...
public class BookRecommendationAgent {
    ...
    public BookRecommendationAgent(
        ...
        String systemPrompt = """
                ...
                사용자의 검색 질문 의도(난이도, 기술 스택, 주제 등)와 가장 완벽하게 부합하는 최상위 도서만 네가 직접 고르고,
                선별 도서 중 relevance가 90점 이상인 도서만 선별해
                ...
                [응답 규칙]
                1. 전달받은 도서 목록 중 점수가 90점 이상인 도서에 대해서만 응답을 생성하고, 나머지 탈락한 도서는 절대 응답에 포함하지 마.

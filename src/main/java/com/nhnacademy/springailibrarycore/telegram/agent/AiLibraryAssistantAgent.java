            ...
            for (Object result : toolResults) {
                if (result instanceof List) {
                    ...
                    for (BookSearchResponse book : books) {
                        // 1. [필터] AI가 추천 사유를 적지 않은(탈락한) 도서는 스킵
                        ...
                        // 2. [이미지 프리뷰] 책 이미지 URL이 있으면 보이지 않는 링크로 프리뷰 유도

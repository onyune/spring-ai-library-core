 ...
 * 필수 조건:{@code libCode}, {@code region}, {@code dtl_region} 중 최소 하나는 반드시 제공되어야 합니다.
 ...
 * @param dtl_region 조회 대상 시군구 코드. 세미콜론(;) 구분자로 다중 지정 지원.
 ...
 * @param from_age   상세 연령 검색 조건의 시작 연령 (0 ~ 120 범위)
 * @param to_age     상세 연령 검색 조건의 종료 연령 (0 ~ 120 범위)
 ...
 * @param dtl_kdc    KDC 세부 주제분류 코드. 세미콜론(;) 구분자로 다중 지정 지원.
